...
public class CreateVisibleSignature extends CreateSignatureBase
{
    ...
    public void setVisibleSignDesigner(PDDocument document, int x, int y, int zoomPercent, 
            FileInputStream imageStream, int page) 
            throws IOException
    {
        visibleSignDesigner = new PDVisibleSignDesigner(document, imageStream, page);
        visibleSignDesigner.xAxis(x).yAxis(y).zoom(zoomPercent).adjustForRotation();
    }
    ...
    public PDSignature signPDF(PDDocument doc, String signatureFieldName) throws IOException{
    ...
    public void signPDF(File inputFile, File signedFile, TSAClient tsaClient, String signatureFieldName) throws IOException
    {
        ...
        PDSignature signature = signPDF(doc,signatureFieldName);
